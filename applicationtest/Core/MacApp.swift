...
extension MacApp{
    ...
    public func didLaunchApplication(in view: OSWindowView, withApplicationWindow appWindow: OSApplicationWindow){}
    
    public func willLaunchApplication(in view: OSWindowView,withApplicationWindow appWindow: OSApplicationWindow){}
